...
def main():
    ...
    # ---- load artifacts ----
    with open("../Result/GAN/models_m.pkl", "rb") as f:
        models_m = pickle.load(f)
    with open("../Result/GAN/handlers_m.pkl", "rb") as f:
        handlers_m = pickle.load(f)
    with open("../Result/GAN/pack_data_m.pkl", "rb") as f:
    ...
    # 其他配置
    args.eps_value = getattr(args, "eps_value", 0.05)

    args.run_stage2 = True
    args.run_stage3 = True

    args.eval_mode = "discrete"
    args.avoid_rand_duplicate = False
    ...
    out_pkl = f"../Result/GAN/compare_res_{optimization_mode}_{problem_mode}_all_joint.pkl"
...
if __name__ == "__main__":
    #python main_GAN_joint.py
    #python main_GAN_joint.py --optimization-mode single --problem-mode dro
    #python main_GAN_joint.py --optimization-mode multi --problem-mode dro --seed 0
    main()